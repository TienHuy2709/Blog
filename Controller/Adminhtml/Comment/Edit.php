 ...
 */
class Edit extends \AHT\Blog\Controller\Adminhtml\Comment implements HttpGetActionInterface
{
    /**
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\AHT\Blog\Model\Comment::class);
