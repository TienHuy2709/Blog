...
use AHT\Blog\Model\BlogFactory;
use AHT\Blog\Model\Blog\ImageUploader;

/**
 * Save CMS block action.
 */
class Save extends \AHT\Blog\Controller\Adminhtml\Blog implements HttpPostActionInterface
{
    /**
    ...
    public function __construct(
        ...
        $this->blogRepository = $blogRepository
            ?: \Magento\Framework\App\ObjectManager::getInstance()->get(BlogRepositoryInterface::class);
    ...
    private function processBlockReturn($model, $data, $resultRedirect)
    {
        ...
        if ($redirect ==='continue') {
            ...
            $duplicateModel->setIsActive(Blog::STATUS_DISABLED);
